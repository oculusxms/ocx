		...
		<div class="col-sm-<?php $span = trim($column_left) ? 9 : 12; $span = trim($column_right) ? $span - 3 : $span; echo $span; ?>">
			...
			<form class="form-inline" role="form">
				<div class="pull-right">
					<button type="submit" id="button-search" class="btn btn-primary"><?= $button_search; ?></button>
				</div>
				<div class="form-group">
					<label class="sr-only" for="filter-name"><?php echo $entry_search; ?></label>
					<input type="text" 
						name="filter_name" 
						class="form-control" 
						id="filter-name" 
						value="<?php echo $filter_name; ?>" 
						placeholder="<?php echo $entry_search; ?>" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<label class="control-label"><?= $text_sub_category; ?></label>
				</div>
				&nbsp;&nbsp;
				<div class="form-group">
					<div class="checkbox checkbox-inline">

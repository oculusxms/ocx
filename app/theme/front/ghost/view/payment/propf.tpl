<fieldset>
	...
	<div class="form-horizontal" id="payment">
		...
		<div class="form-group">
			<label class="control-label col-sm-3" for="cc_type"><?= $entry_cc_type; ?></label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label class="control-label col-sm-3" for="cc_start_date_month"><?= $entry_cc_start_date; ?></label>
			<div class="col-sm-3">
				...
				<div class="help-block"><?= $text_start_date; ?></div>
			</div>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label class="control-label col-sm-3" for="cc_expire_date_month"><?= $entry_cc_expire_date; ?></label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label class="control-label col-sm-3" for="cc_issue"><?= $entry_cc_issue; ?></label>
			<div class="col-sm-6">
				<input type="text" name="cc_issue" value="" class="form-control" placeholder="<?= $entry_cc_issue; ?>"  id="cc_issue">
				<div class="help-block"><?= $text_issue; ?></div>
			</div>
		</div>
	</div>
</fieldset>

...
<p class="heading1" align="left" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:14px; line-height:22px; color:#333333; margin-top:0px; margin-bottom:10px;">
	<strong><?= $lang_text_new_received; ?></strong>
</p>
...
<thead>
	<tr>
    	<th bgcolor="#ededed" colspan="2" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:14px; font-weight:bold;"><?= $lang_text_order_detail; ?></th>
   	</tr>
</thead>
<tbody>
	<tr>
    	<td bgcolor="#fafafa" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; border-bottom:1px solid #e0e0e0; word-wrap:normal;">
    		...
    		<?php } ?>
          	...
          	<?php if(isset($order_weight) && $order_weight > 0){ ?><b><?= $lang_text_weight; ?></b> <?= $order_weight_fvalue; ?><br /><?php } ?>
        ...
        <td bgcolor="#fafafa" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; border-bottom:1px solid #e0e0e0; border-left:1px solid #e0e0e0; word-wrap:normal;">
        	<b><?= $lang_text_email; ?></b> <a href="mailto:<?= $email; ?>" style="text-decoration:none; word-wrap:normal;"><?= $email; ?></a><br />
          	<b><?= $lang_text_telephone; ?></b> <?= $telephone; ?><br />
          	<b><?= $lang_text_ip; ?></b> <?= $ip; ?>
          	<?php if($customer_group){ ?>
          		<br /><b><?= $lang_text_customer_group; ?></b> <?= $customer_group; ?>
          	<?php } ?>
          	<?php if($affiliate){ ?>
          		<br /><b><?= $lang_text_affiliate; ?></b> [#<?= $affiliate['affiliate_id']; ?>]
...
<tbody>
    ...
    <tr>
		<td bgcolor="<?= $row_style_background; ?>" align="left" style="word-wrap:normal; text-align: left; -ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; border-bottom:1px solid #e0e0e0;">
			...
			<?php if(isset($product['model']) && $product['model']){ ?><br /><b><?= $lang_text_model; ?>:</b> <?= $product['model']; ?><?php } ?>
			<?php if(isset($product['weight']) && $product['weight'] > 0){ ?><br /><b><?= $lang_text_product_weight; ?>:</b> <?= $product['weight_fvalue']; ?><?php } ?>
			<?php if(isset($product['sku']) && $product['sku']){ ?><br /><b><?= $lang_text_sku; ?>:</b> <?= $product['sku']; ?><?php } ?>
			<?php if(isset($product['product_id'])){ ?><br /><b><?= $lang_text_id; ?>:</b> <?= $product['product_id']; ?><?php } ?>
			<?php if(isset($product['stock_quantity'])){ ?><br /><b><?= $lang_text_stock_quantity; ?></b> <span style="color: <?php if($product['stock_quantity'] <= 0) { echo '#FF0000'; } elseif($product['stock_quantity'] <= 5) { echo '#FFA500'; } else { echo '#008000'; }?>"><?= $product['stock_quantity']; ?></span><?php } ?>
			
			<?php if(!empty($product['option'])){ ?>
			<br style="clear:both" />
			<b><?= $lang_text_product_options; ?></b>
...
<p class="standard" align="left" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; color:#333333; margin-top:0px; margin-bottom:0px;">
	<strong><?= $lang_text_new_instruction; ?></strong><br />
	<?= $instruction; ?>
</p>
<?php } ?>

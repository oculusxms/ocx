	...
	<form id="form-guest" class="form-horizontal">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="firstname" value="<?= $firstname; ?>" class="form-control" placeholder="<?= $entry_firstname; ?>"  id="firstname" autofocus required>
				</div>
			</div>
			<div class="form-group">
		...
		<fieldset>
			...
			<div class="form-group">
				<div class="col-sm-6 col-sm-offset-3">
					...
					<div class="checkbox"><label><input type="checkbox" name="shipping_address" value="1" checked=""><?= $entry_shipping; ?></label></div>
					<?php } else { ?>
...
<div class="panel-footer text-right">
	<button type="button" id="button-guest" class="btn btn-primary load-left"><?= $button_continue; ?></button>
</div>
<?= $javascript; ?>
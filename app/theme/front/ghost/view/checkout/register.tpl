	...
	<form class="form-horizontal">
		<fieldset>
			...
			<div class="form-group">
				<label class="control-label col-sm-3" for="username"><b class="required">*</b> <?= $entry_username; ?></label>
				<div class="col-sm-6">
					<input type="text" name="username" value="" class="form-control" placeholder="<?= $entry_username; ?>"  id="username" required autofocus>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="email" value="" class="form-control" placeholder="<?= $entry_email; ?>"  id="email" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-3" for="telephone"><b class="required">*</b> <?= $entry_telephone; ?></label>
				<div class="col-sm-6">
					<input type="text" name="telephone" value="" class="form-control" placeholder="<?= $entry_telephone; ?>"  id="telephone" required>
				</div>
			</div>
		</fieldset>
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="password" name="password" value="" class="form-control" placeholder="<?= $entry_password; ?>"  id="password" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-3" for="confirm"><b class="required">*</b> <?= $entry_confirm; ?></label>
				<div class="col-sm-6">
					<input type="password" name="confirm" value="" class="form-control" placeholder="<?= $entry_confirm; ?>"  id="confirm" required>
				</div>
			</div>
		</fieldset>
		<fieldset>
			...
			<div class="form-group" id="company-id-display">
				<label class="control-label col-sm-3" for="company_id"><b id="company-id-required" class="required">*</b> <?= $entry_company_id; ?></label>
				<div class="col-sm-6">
			...
			<div class="form-group" id="tax-id-display">
				<label class="control-label col-sm-3" for="tax_id"><b id="tax-id-required" class="required">*</b> <?= $entry_tax_id; ?></label>
				<div class="col-sm-6">
			...
			<div class="form-group">
				<div class="col-sm-6 col-sm-offset-3">
					...
					<?php if ($shipping_required) { ?>
						<div class="checkbox"><label><input type="checkbox" name="shipping_address" value="1"><?= $entry_shipping; ?></label></div>
					<?php } ?>
					<?php if ($text_agree) { ?>
...
<div class="panel-footer text-right">
	<button type="button" id="button-register" class="btn btn-primary load-left"><?= $button_continue; ?></button>
</div>
<?= $javascript; ?>
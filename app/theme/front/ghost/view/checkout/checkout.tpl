	...
	<div class="col-sm-<?php $span=trim($column_left) ? 9 : 12; $span=trim($column_right) ? $span - 3 : $span; echo $span; ?>">
		...
		<div id="checkout-container" class="panel-group">
			<div id="checkout" class="panel panel-default">
				<div class="panel-heading"><?= $text_checkout_option; ?></div>
			...
			<div id="shipping-address" class="panel panel-default">
				<div class="panel-heading"><?= $text_checkout_shipping_address; ?></div>
				<div class="panel-collapse collapse"></div>
			</div>
			<div id="shipping-method" class="panel panel-default">
				<div class="panel-heading"><?= $text_checkout_shipping_method; ?></div>
				<div class="panel-collapse collapse"></div>
			</div>
			<?php } ?>
			<div id="payment-method" class="panel panel-default">
				<div class="panel-heading"><?= $text_checkout_payment_method; ?></div>
				<div class="panel-collapse collapse"></div>
			</div>
			<div id="confirm" class="panel panel-default">
				<div class="panel-heading"><?= $text_checkout_confirm; ?></div>
				<div class="panel-collapse collapse"></div>
			</div>
		</div>
		<?= $content_bottom; ?>

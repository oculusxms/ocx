			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th class="text-right hidden-xs"><?= $column_stock; ?></th>
						...
						<tr id="wishlist-row<?= $product['product_id']; ?>">
							...
							<td class="text-right">
								...
								<button type="button" 
									...
									class="btn btn-primary load-left">
									<?= str_replace('Event', '<i title="View Event" class="fa fa-shopping-users"></i>', $button_view_event); ?>
								</button>
								<?php endif; ?>
								<a class="btn btn-danger" href="<?= $product['remove']; ?>" data-toggle="tooltip" title="<?= $button_remove; ?>"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
					<?php } ?>
				</tbody>

...
<div class="row">
	...
	<div class="col-sm-<?php $span = trim($column_left) ? 9 : 12; $span = trim($column_right) ? $span - 3 : $span; echo $span; ?>">
		...
		<form id="search-complete" title="<?= $text_critea; ?>">
			<div class="form-inline">
				...
				<input type="search" name="search" value="<?= $search; ?>" class="form-control" placeholder="<?= $entry_search; ?>">
				<button type="submit" form="search-complete" class="btn btn-primary"><i class="fa fa-search"></i> <?= $button_search; ?></button>
			</div>
			<div class="checkbox"><label><input type="checkbox" name="sub_category" value="1"<?= $sub_category ? ' checked=""' : ''; ?>> <?= $text_sub_category; ?></label></div>
			<div class="checkbox"><label><input type="checkbox" name="description" value="1"<?= $description ? ' checked=""' : ''; ?>> <?= $entry_description; ?></label></div>
		</form>
		<?php if ($products) { ?>

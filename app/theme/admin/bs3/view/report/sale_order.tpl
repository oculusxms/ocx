	...
	<div class="panel-body">
		<div id="filter" class="well">
			<div class="row">
				...
				<div class="col-sm-2">
					<select name="filter_group" title="<?= $entry_group; ?>" class="form-control">
		...
		<table class="table table-bordered table-striped">
			<thead>
				<tr>
					...
					<th class="text-right hidden-xs"><?= $column_orders; ?></th>
					<th class="text-right hidden-xs"><?= $column_products; ?></th>
					<th class="text-right hidden-xs"><?= $column_tax; ?></th>
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-right hidden-xs"><?= $order['orders']; ?></td>
					<td class="text-right hidden-xs"><?= $order['products']; ?></td>
					<td class="text-right hidden-xs"><?= $order['tax']; ?></td>

...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<ul class="nav nav-tabs"><li><a href="#tab-general" data-toggle="tab"><?= $tab_general; ?></a></li>
			<?php if ($customer_id) { ?>
			<li><a href="#tab-transaction" data-toggle="tab"><?= $tab_transaction; ?></a></li><li><a href="#tab-reward" data-toggle="tab"><?= $tab_reward; ?></a></li>
			<?php } ?>
			...
			<div class="tab-content">
				<div class="tab-pane" id="tab-general">
					<div class="row">
						<div class="col-sm-2">
							<div class="tabs-left">
								<ul id="vtab-address" class="nav nav-tabs"><li><a href="#tab-customer" data-toggle="tab"><?= $tab_general; ?></a></li>
									<?php $address_row = 1; ?>
									...
									<li class="action" id="address-add">
										<button type="button" id="address-button" class="btn btn-info btn-block"><i class="fa fa-plus-circle"></i>&nbsp;<?= $button_add_address; ?></button>
									</li>
								</ul>
							</div>
						</div>
						<div class="col-sm-10">
							<div class="tab-content" id="customer-content">
								<div class="tab-pane" id="tab-customer">
									...
									<div class="form-group">
										<label class="control-label col-sm-2"><?= $entry_newsletter; ?></label>
										<div class="control-field col-sm-4">
								...
								<?php foreach ($addresses as $address) { ?>
									<div class="tab-pane" id="tab-address-<?= $address_row; ?>">
										...
										<div class="form-group company-id-display">
											<label class="control-label col-sm-2"><?= $entry_company_id; ?></label>
											<div class="control-field col-sm-4">
										...
										<div class="form-group tax-id-display">
											<label class="control-label col-sm-2"><?= $entry_tax_id; ?></label>
											<div class="control-field col-sm-4">
										...
										<div class="form-group">
											<label class="control-label col-sm-2"><span id="postcode-required<?= $address_row; ?>" class="required">*</span> <?= $entry_postcode; ?></label>
											<div class="control-field col-sm-4">
										...
										<div class="form-group">
											<label class="control-label col-sm-2" for="default<?= $address_row; ?>"><?= $entry_default; ?></label>
											<div class="control-field col-sm-4">
				...
				<?php if ($customer_id) { ?>
					<div class="tab-pane" id="tab-transaction">
						...
						<div class="form-group">
							<div class="control-field col-sm-4 col-sm-offset-2">
								<button type="button" id="button-transaction" data-target="customer" data-id="<?= $customer_id; ?>" class="btn btn-info"><i class="fa fa-plus-circle"></i> <?= $button_add_transaction; ?></button>
							</div>
						</div>
					</div>
					<div class="tab-pane" id="tab-reward">
						...
						<div class="form-group">
							<div class="control-field col-sm-4 col-sm-offset-2">
								<button type="button" id="button-reward" class="btn btn-info"><i class="fa fa-plus-circle"></i> <?= $button_add_reward; ?></button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<table class="table table-bordered table-striped table-hover">
						<thead>
							<tr>
								...
								<th class="col-sm-4 text-right"><?= $column_action; ?></th>
							</tr>
						</thead>
						<tbody>
						<?php if ($ips) { ?>
						<?php foreach ($ips as $ip) { ?>
							<tr>
								...
								<td class="text-right"><?php if ($ip['ban_ip']) { ?>
									<span class="bracket"><a id="<?= str_replace('.', '-', $ip['ip']); ?>" onclick="removeBanIP('<?= $ip['ip']; ?>');"><?= $text_remove_ban_ip; ?></a></span>
									<?php } else { ?>
									<span class="bracket"><a id="<?= str_replace('.', '-', $ip['ip']); ?>" onclick="addBanIP('<?= $ip['ip']; ?>');"><?= $text_add_ban_ip; ?></a></span>
									<?php } ?>
								</td>
							</tr>
							<?php } ?>

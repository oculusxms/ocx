			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?= $sort_name; ?>"><?= $column_name; echo ($sort == 'cgd.name') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right hidden-xs"><a href="<?= $sort_sort_order; ?>"><?= $column_sort_order; echo ($sort == 'cg.sort_order') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
				...
				<tbody data-link="row" class="rowlink">
					...
					<tr>
						<td class="rowlink-skip text-center"><?php if ($customer_group['selected']) { ?>
							<input type="checkbox" name="selected[]" value="<?= $customer_group['customer_group_id']; ?>" checked="">
							<?php } else { ?>
							<input type="checkbox" name="selected[]" value="<?= $customer_group['customer_group_id']; ?>">
							<?php } ?></td>
						<td><?= $customer_group['name']; ?></td>
						<td class="text-right hidden-xs"><?= $customer_group['sort_order']; ?></td>

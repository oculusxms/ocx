...
function addOptionValue(){
	...
	html += '<a class="btn btn-default" onclick="image_upload(\'image'+option_value_row+'\',\'thumb'+option_value_row+'\');"><?= $text_browse; ?></a>&nbsp;';
	html += '<a class="btn btn-default" onclick="$(\'#thumb'+option_value_row+'\').attr(\'src\',\'<?= $no_image; ?>\'); $(\'#image'+option_value_row+'\').attr(\'value\',\'\');"><?= $text_clear; ?></a>';
	html += '</div>';
	html += '</div></td>';

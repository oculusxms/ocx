...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_iso_code_2; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="iso_code_2" value="<?= $iso_code_2; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_iso_code_3; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="iso_code_3" value="<?= $iso_code_3; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_address_format; ?></label>
				<div class="control-field col-sm-8">
					<textarea name="address_format" class="form-control" rows="8"><?= $address_format; ?></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_postcode_required; ?></label>
				<div class="control-field col-sm-4">
					<?php if ($postcode_required) { ?>
						<label class="radio-inline"><input type="radio" name="postcode_required" value="1" checked=""><?= $text_yes; ?></label>
						<label class="radio-inline"><input type="radio" name="postcode_required" value="0"><?= $text_no; ?></label>
						<?php } else { ?>
						<label class="radio-inline"><input type="radio" name="postcode_required" value="1"><?= $text_yes; ?></label>
						<label class="radio-inline"><input type="radio" name="postcode_required" value="0" checked=""><?= $text_no; ?></label>
					<?php } ?>
				</div>
			</div>
			<div class="form-group">

			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<?php foreach ($languages as $language) { ?>
						<div class="input-group"><input type="text" name="order_status[<?= $language['language_id']; ?>][name]" value="<?= isset($order_status[$language['language_id']]) ? $order_status[$language['language_id']]['name'] :''; ?>" class="form-control">

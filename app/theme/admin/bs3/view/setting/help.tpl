				...
				<div class="col-sm-12 table-responsive">
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<tbody>
							...
							<!-- admin recurring profiles -->
							<tr>
								<td>admin_add_profile</td>
								<td>(array)profile_id</td>
								<td>Admin\Model\Catalog\Profile\addProfile</td>
							</tr>
							<tr>
								<td>admin_update_profile</td>
								<td>(array)profile_id</td>
								<td>Admin\Model\Catalog\Profile\updateProfile</td>
							</tr>
							<tr>
								<td>admin_delete_profile</td>
								<td>(array)profile_id</td>
								<td>Admin\Model\Catalog\Profile\deleteProfile</td>
							</tr>
							<!-- admin recurring -->
							<tr>

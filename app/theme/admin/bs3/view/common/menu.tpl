	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?= $dashboard; ?>">
				<img src="../asset/bs3/img/logo.png" class="img-responsive" alt="<?= $lang_heading_title; ?>">
			</a>
		</div>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown" id="help">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="http://ocx.io" target="_blank"><?= $lang_text_ocx; ?></a></li>
						<li><a href="<?= $help; ?>"><?= $lang_text_documentation; ?></a></li>
						<li><a href="http://forum.ocx.io" target="_blank"><?= $lang_text_support; ?></a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown">

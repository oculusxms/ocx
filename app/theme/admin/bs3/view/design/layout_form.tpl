...
<div class="panel panel-default">
	<div class="panel-heading">
		<div class="clearfix">
			<div class="pull-left h2"><i class="hidden-xs fa fa-th"></i><?= $heading_title; ?></div>
			...
			<table id="route" class="table table-bordered table-striped">
				...
				<?php foreach ($layout_routes as $layout_route) { ?>
					<tr id="route-row<?= $route_row; ?>">
						...
						<td><a onclick="$('#route-row<?= $route_row; ?>').remove();" class="btn btn-danger"><i class="fa fa-trash-o fa-lg"></i><span class="hidden-xs"> <?= $button_remove; ?></span></a></td>
					</tr>
				<?php $route_row++; ?>
				<?php } ?>
				</tbody>
				<tfoot>
					<tr>
						<td colspan="2"></td>
						<td><a onclick="addRoute();" class="btn btn-info"><i class="fa fa-plus-circle"></i><span class="hidden-xs"> <?= $button_add_route; ?></span></a></td>
					</tr>
				</tfoot>
			</table>
		</form>

...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<div class="pull-right"><a class="btn btn-default" href="<?= $invoice; ?>" target="_blank"><i class="fa fa-print"></i><span class="hidden-xs"> <?= $button_invoice; ?></span></a> <a class="btn btn-warning" href="<?= $cancel; ?>"><i class="fa fa-ban"></i> <?= $button_cancel; ?></a></div>
	</div>
	<div class="panel-body">
		<div class="tabbable">
			<ul class="nav nav-tabs"><li><a href="#tab-order" data-toggle="tab"><?= $tab_order; ?></a></li><li><a href="#tab-payment" data-toggle="tab"><?= $tab_payment; ?></a></li>
				<?php if ($shipping_method) { ?>
				<li><a href="#tab-shipping" data-toggle="tab"><?= $tab_shipping; ?></a></li>
				<?php } ?>
				<li><a href="#tab-product" data-toggle="tab"><?= $tab_product; ?></a></li><li><a href="#tab-history" data-toggle="tab"><?= $tab_history; ?></a></li>
				<?php if ($maxmind_id) { ?>
			...
			<div class="tab-content">
				<div id="tab-order" class="tab-pane">
					<table class="table table-bordered table-striped table-hover">
						<tr>
							<td class="col-sm-3"><?= $text_order_id; ?></td>
							<td>#<?= $order_id; ?></td>
						</tr>
						<tr>
							...
							<td><?php if ($invoice_no) { ?>
								<?= $invoice_no; ?>
								<?php } else { ?>
								<span id="invoice"><button type="button" class="btn btn-default" id="invoice-generate"><?= $text_generate; ?></button></span>
								<?php } ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php if ($credit && $customer) { if (!$credit_total) { ?>
								<button type="button" class="btn btn-default" id="credit" data-action="add"><b class="badge badge-info"><?= $total; ?></b>&nbsp;<span><?= $text_credit_add; ?></span></button>
								<?php } else { ?>
								<button type="button" class="btn btn-default" id="credit" data-action="remove"><b class="badge badge-info"><?= $total; ?></b>&nbsp;<span><?= $text_credit_remove; ?></span></button>
						...
						<tr>
							...
							<td><?php if (!$reward_total) { ?>
								<button type="button" class="btn btn-default" id="reward" data-action="add"><b class="badge badge-info"><?= $reward; ?></b>&nbsp;<span><?= $text_reward_add; ?></span></button>
								<?php } else { ?>
								<button type="button" class="btn btn-default" id="reward" data-action="remove"><b class="badge badge-info"><?= $reward; ?></b>&nbsp;<span><?= $text_reward_remove; ?></span></button>
								<?php } ?></td>
						</tr>
						<?php } ?>
						<?php if ($order_status) { ?>
						...
						<tr>
							...
							<td><?php if (!$commission_total) { ?>
								<button type="button" class="btn btn-default" id="commission" data-action="add"><b class="badge badge-info"><?= $commission; ?></b>&nbsp;<span><?= $text_commission_add; ?></span></button>
								<?php } else { ?>
								<button type="button" class="btn btn-default" id="commission" data-action="remove"><b class="badge badge-info"><?= $commission; ?></b>&nbsp;<span><?= $text_commission_remove; ?></span></button>
								<?php } ?></td>
						</tr>
						<?php } ?>
						<?php if ($ip) { ?>
				...
				<div id="tab-payment" class="tab-pane">
					<table class="table table-bordered table-striped table-hover">
						<tr>
							<td class="col-sm-3"><?= $text_firstname; ?></td>
				...
				<div id="tab-product" class="tab-pane">
					<table class="table table-bordered table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								<td><a href="<?= $voucher['href']; ?>"><?= $voucher['description']; ?></a></td>
								<td></td>
					...
					<table class="table table-bordered table-striped table-hover">
						<thead>
							<tr>
								<th><?= $column_download; ?></th>
								<th><?= $column_filename; ?></th>
								<th class="text-right"><?= $column_remaining; ?></th>
							</tr>
						</thead>
						<tbody>
				...
				<div id="tab-history" class="tab-pane">
					<div id="history" data-href="index.php?route=sale/order/history&token=<?= $token; ?>&order_id=<?= $order_id; ?>"></div>
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="notify"><?= $entry_notify; ?></label>
							<div class="control-field col-sm-4">
								<label class="checkbox-inline"><input type="checkbox" name="notify" value="1" id="notify"></label>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="comment"><?= $entry_comment; ?></label>
							<div class="control-field col-sm-4">
						...
						<div class="form-group">
							<div class="control-field col-sm-4 col-sm-offset-2">
								<button type="button" id="button-history" data-action="order" data-id="<?= $order_id; ?>" class="btn btn-info"><i class="fa fa-plus-circle"></i> <?= $button_add_history; ?></button>
							</div>
						</div>
					</div>
				</div>

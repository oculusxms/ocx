...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<div class="pull-right"><a class="btn btn-warning" href="<?= $cancel; ?>"><i class="fa fa-ban"></i> <?= $button_cancel; ?></a></div>
	</div>
	<div class="panel-body">
		<ul class="nav nav-tabs"><li><a href="#tab-return" data-toggle="tab"><?= $tab_return; ?></a></li><li><a href="#tab-product" data-toggle="tab"><?= $tab_product; ?></a></li><li><a href="#tab-history" data-toggle="tab"><?= $tab_history; ?></a></li></ul>
		<div class="form-horizontal tab-content">
			<div class="tab-pane" id="tab-return">
				<table class="table table-bordered table-striped table-hover">
					<tr>
						<td class="col-sm-3"><?= $text_return_id; ?></td>
						<td><?= $return_id; ?></td>
					</tr>
					<tr>
						<td><?= $text_order_id; ?></td>
			...
			<div class="tab-pane" id="tab-product">
				<table class="table table-bordered table-striped table-hover">
					<tr>
						<td class="col-sm-3"><?= $text_product; ?></td>
						<td><?= $product; ?></td>
					</tr>
					<tr>
						<td><?= $text_model; ?></td>
			...
			<div class="tab-pane" id="tab-history">
				...
				<div class="form-group">
					<label class="control-label col-sm-2"><?= $entry_notify; ?></label>
					<div class="control-field col-sm-4">
				...
				<div class="form-group">
					<div class="control-field col-sm-4 col-sm-offset-2">
						<button type="button" id="button-history" data-action="return" data-id="<?= $return_id; ?>" class="btn btn-info"><i class="fa fa-plus-circle"></i> <?= $button_add_history; ?></button>
					</div>
				</div>
			</div>
		</div>

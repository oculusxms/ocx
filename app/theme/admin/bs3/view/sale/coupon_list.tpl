			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th class="hidden-xs"><a href="<?= $sort_code; ?>"><?= $column_code; echo ($sort == 'code') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right"><a href="<?= $sort_discount; ?>"><?= $column_discount; echo ($sort == 'discount') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="hidden-xs"><a href="<?= $sort_date_start; ?>"><?= $column_date_start; echo ($sort == 'date_start') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="hidden-xs"><a href="<?= $sort_date_end; ?>"><?= $column_date_end; echo ($sort == 'date_end') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>

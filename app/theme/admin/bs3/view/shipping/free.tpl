		...
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="free_total" value="<?= $free_total; ?>" class="form-control" autofocus>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_geo_zone; ?></label>
				<div class="control-field col-sm-4">
					<select name="free_geo_zone_id" class="form-control">
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="free_sort_order" value="<?= $free_sort_order; ?>" class="form-control">
				</div>
			</div>
		</form>
	</div>

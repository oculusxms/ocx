...
<div class="panel panel-default">
	...
	<div class="panel-body"> 
		<form class="form-inline" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<table class="form">
				<tr>
					<td><b class="required">*</b> <?= $entry_vendor; ?><br><span class="help-block muted"><?= $help_vendor ?></span></td>
				...
				<tr>
					<td><b class="required">*</b> <?= $entry_user; ?><br><span class="help-block muted"><?= $help_user ?></span></td>
				...
				<tr>
					<td><b class="required">*</b> <?= $entry_password; ?><br><span class="help-block muted"><?= $help_password ?></span></td>
				...
				<tr>
					<td><b class="required">*</b> <?= $entry_partner; ?><br><span class="help-block muted"><?= $help_partner ?></span></td>
				...
				<tr>
					<td><?= $entry_transaction_method; ?></td>
				...
				<tr>
					<td><?= $entry_debug; ?><br><span class="help-block muted"><?= $help_debug ?></span></td>
				...
				<tr>
					<td><?= $entry_checkout_method ?><br><span class="help-block muted"><?= $help_checkout_method ?></span></td>
				...
				<tr>
					<td><?= $entry_cancel_url; ?></td>
					<td><?= $cancel_url ?></td>
				</tr>
				<tr>
					<td><?= $entry_error_url; ?></td>
					<td><?= $error_url ?></td>
				</tr>
				<tr>
					<td><?= $entry_return_url; ?></td>
					<td><?= $return_url ?></td>
				</tr>
				<tr>
					<td><?= $entry_post_url; ?></td>
					<td><?= $post_url ?></td>
				</tr>
			</table>
		</form>

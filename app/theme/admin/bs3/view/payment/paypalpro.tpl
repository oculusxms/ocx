...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><b class="required">*</b> <?= $entry_signature; ?></label>
				<div class="control-field col-sm-4">
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<?php if ($paypalpro_test) { ?>
						<label class="radio-inline"><input type="radio" name="paypalpro_test" value="1" checked=""><?= $text_yes; ?></label>
						<label class="radio-inline"><input type="radio" name="paypalpro_test" value="0"><?= $text_no; ?></label>
						<?php } else { ?>
						<label class="radio-inline"><input type="radio" name="paypalpro_test" value="1"><?= $text_yes; ?></label>
						<label class="radio-inline"><input type="radio" name="paypalpro_test" value="0" checked=""><?= $text_no; ?></label>
						<?php } ?>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_transaction; ?></label>
				<div class="control-field col-sm-4">

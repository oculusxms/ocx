		...
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="cod_total" value="<?= $cod_total; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_order_status; ?></label>
				<div class="control-field col-sm-4">
					<select name="cod_order_status_id" class="form-control">
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<select name="cod_geo_zone_id" class="form-control">
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="cod_sort_order" value="<?= $cod_sort_order; ?>" class="form-control">
				</div>
			</div>
		</form>
	</div>

...
<table class="form">
	...
	<tr>
		...
		<td>
			...
			<?php if ($paypal_order['capture_status'] != 'Complete'){ ?>&nbsp;&nbsp;
				<a onclick="doVoid();" class="button paypal_capture" id="button-void"><?= $button_void; ?></a>
	...
	<tr class="paypal_capture">
		...
		<td>
			...
			<p>
				...
				<a class="btn btn-default" onclick="capture();" id="button-capture"><?= $button_capture; ?></a>
	...
	<tr>
		...
		<td><a id="button-reauthorise" onclick="reauthorise()" class="btn btn-default"><?= $button_reauthorise ?></a></td>
	</tr>
	<?php } ?>
	<tr>

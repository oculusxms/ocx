			...
			<table id="widget" class="table table-bordered table-striped">
				...
				<?php foreach ($widgets as $widget) { ?>
					<tr id="widget-row<?= $widget_row; ?>">
						<td><input type="text" name="special_widget[<?= $widget_row; ?>][limit]" value="<?= $widget['limit']; ?>" class="form-control"></td>
						<td><input type="text" name="special_widget[<?= $widget_row; ?>][image_width]" value="<?= $widget['image_width']; ?>" class="form-control">
							<input type="text" name="special_widget[<?= $widget_row; ?>][image_height]" value="<?= $widget['image_height']; ?>" class="form-control">
							<?php if (isset($error_image[$widget_row])) { ?>
							<div class="text-danger"><?= $error_image[$widget_row]; ?></div>
							<?php } ?></td>
						<td><select name="special_widget[<?= $widget_row; ?>][layout_id]" class="form-control">
						...
						<td><select name="special_widget[<?= $widget_row; ?>][position]" class="form-control">
						...
						<td><div class="btn-group" data-toggle="buttons">
							...
							<label class="btn btn-default active" title="<?= $text_enabled; ?>"><input type="radio" name="special_widget[<?= $widget_row; ?>][status]" value="1" checked=""><i class="fa fa-play"></i></label>
							<label class="btn btn-default" title="<?= $text_disabled; ?>"><input type="radio" name="special_widget[<?= $widget_row; ?>][status]" value="0"><i class="fa fa-pause"></i></label>
							<?php } else { ?>
							<label class="btn btn-default" title="<?= $text_enabled; ?>"><input type="radio" name="special_widget[<?= $widget_row; ?>][status]" value="1"><i class="fa fa-play"></i></label>
							<label class="btn btn-default active" title="<?= $text_disabled; ?>"><input type="radio" name="special_widget[<?= $widget_row; ?>][status]" value="0" checked=""><i class="fa fa-pause"></i></label>
							<?php } ?>
						</div></td>
						<td class="text-right"><input type="text" name="special_widget[<?= $widget_row; ?>][sort_order]" value="<?= $widget['sort_order']; ?>" class="form-control"></td>

	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<ul id="tabs" class="nav nav-tabs">
				...
				<li><a href="#tab-widget-<?= $widget_row; ?>" data-toggle="tab" id="widget-<?= $widget_row; ?>"><span class="label label-danger" onclick="removeWidget('<?= $widget_row; ?>');"><i class="fa fa-trash-o fa-lg"></i></span>&nbsp;&nbsp;<?= $tab_widget . ' ' . $widget_row; ?></a></li>
				<?php $widget_row++; ?>
				<?php } ?>
				<li id="widget-add" class="active"><a onclick="addWidget();"><i class="fa fa-plus-circle fa-lg fa-fw"></i>&nbsp;<?= $button_add_widget; ?></a></li>
			</ul>
			<div class="tab-content" id="append">
				...
				<div class="tab-pane" id="tab-widget-<?= $widget_row; ?>">
					...
					<div class="tab-content">
						...
						<div class="form-group">
							<label class="control-label col-sm-2"><?= $entry_position; ?></label>
							<div class="control-field col-sm-4">
						...
						<div class="form-group">
							...
							<div class="control-field col-sm-4">
								<div class="btn-group" data-toggle="buttons">
									...
									<label class="btn btn-default active" title="<?= $text_enabled; ?>"><input type="radio" name="welcome_widget[<?= $widget_row; ?>][status]" value="1" checked=""><i class="fa fa-play"></i></label>
									<label class="btn btn-default" title="<?= $text_disabled; ?>"><input type="radio" name="welcome_widget[<?= $widget_row; ?>][status]" value="0"><i class="fa fa-pause"></i></label>
									<?php } else { ?>
									<label class="btn btn-default" title="<?= $text_enabled; ?>"><input type="radio" name="welcome_widget[<?= $widget_row; ?>][status]" value="1"><i class="fa fa-play"></i></label>
									<label class="btn btn-default active" title="<?= $text_disabled; ?>"><input type="radio" name="welcome_widget[<?= $widget_row; ?>][status]" value="0" checked=""><i class="fa fa-pause"></i></label>
									<?php } ?>
								</div>
							</div>
						</div>

			...
			<table id="widget" class="table table-bordered table-striped">
				...
				<?php foreach ($widgets as $widget) { ?>
					<tr id="widget-row<?= $widget_row; ?>">
						<td><select name="sidebarmenu_widget[<?= $widget_row; ?>][menu_id]" class="form-control">
						...
						<td><select name="sidebarmenu_widget[<?= $widget_row; ?>][layout_id]" class="form-control">
						...
						<td><select name="sidebarmenu_widget[<?= $widget_row; ?>][position]" class="form-control">
						...
						<td><div class="btn-group" data-toggle="buttons">
							...
							<label class="btn btn-default active" title="<?= $text_enabled; ?>">
								<input type="radio" name="sidebarmenu_widget[<?= $widget_row; ?>][status]" value="1" checked=""><i class="fa fa-play"></i>
							</label>
							<label class="btn btn-default" title="<?= $text_disabled; ?>">
								<input type="radio" name="sidebarmenu_widget[<?= $widget_row; ?>][status]" value="0"><i class="fa fa-pause"></i>
							</label>
							<?php else: ?>
							<label class="btn btn-default" title="<?= $text_enabled; ?>">
								<input type="radio" name="sidebarmenu_widget[<?= $widget_row; ?>][status]" value="1"><i class="fa fa-play"></i>
							</label>
							<label class="btn btn-default active" title="<?= $text_disabled; ?>">
								<input type="radio" name="sidebarmenu_widget[<?= $widget_row; ?>][status]" value="0" checked=""><i class="fa fa-pause"></i>
							</label>
							<?php endif; ?>
						</div></td>
						<td class="text-right">
							<input type="text" name="sidebarmenu_widget[<?= $widget_row; ?>][sort_order]" value="<?= $widget['sort_order']; ?>" class="form-control">
						</td>
						<td>

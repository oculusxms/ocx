...
<div class="panel panel-default">
    <div class="panel-heading">
      <div class="clearfix">
			<div class="pull-left h2"><i class="hidden-xs fa fa-th-list"></i><?= $heading_title; ?></div>
    ...
    <div class="panel-body">
		<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-2 control-label" for="name"><b class="required">*</b> <?= $entry_name; ?></label>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="type"><b class="required">*</b> <?= $entry_menu_type; ?></label>
				<div class="control-field col-sm-4">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><b class="required">*</b> <?= $entry_status; ?></label>
				<div class="col-sm-3">

...
<div class="panel panel-default">
	<div class="panel-heading">
		<div class="clearfix">
			<div class="pull-left h2"><i class="hidden-xs fa fa-rss"></i><?= $heading_title; ?></div>
		...
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<select name="googlesitemap_status" class="form-control">
						<?php if ($googlesitemap_status) { ?>
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_data_feed; ?></label>
				<div class="control-field col-sm-8">
					<textarea class="form-control" rows="5"><?= $data_feed; ?></textarea>
				</div>
			</div>
		</form>
	</div>

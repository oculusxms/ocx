		...
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="tab-content">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="language<?= $language['language_id']; ?>">
								<div class="form-group">
									<label class="control-label col-sm-2" for="name<?= $language['language_id']; ?>"><b class="required">*</b> <?= $entry_title; ?></label>
									<div class="col-sm-6">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><b class="required">*</b> <?= $entry_meta_description; ?></label>
									<div class="col-sm-6">
				...
				<div class="tab-pane" id="tab-data">
					<div class="form-group">
						<label class="control-label col-sm-2" for="store"><?= $entry_store; ?></label>
						<div class="control-field col-sm-4">
							<div class="panel panel-default panel-scrollable">
								<div class="list-group list-group-hover">
									<label class="list-group-item">
										<?php if (in_array(0, $page_store)) { ?>
										<input type="checkbox" name="page_store[]" value="0" checked=""><?= $text_default; ?>
										<?php } else { ?>
										<input type="checkbox" name="page_store[]" value="0"><?= $text_default; ?>
										<?php } ?>
									</label>
						...
						<div class="control-field col-sm-4">
							<div class="input-group">
								...
								<span class="input-group-btn">
									<button class="btn btn-default" id="info-slug-btn" type="button"><?= $text_build; ?></button>
								</span>
							</div>
							<?php if ($error_slug): ?>
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="bottom"><?= $entry_bottom; ?></label>
						<div class="control-field col-sm-4">
							<?php if ($bottom) { ?>

		...
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="tab-content">
					...
					<div id="language-tabs">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="language<?= $language['language_id']; ?>">
								...
								<div class="form-group">
									<label class="control-label col-sm-2"><b class="required">*</b> <?= $entry_meta_keyword; ?></label>
									<div class="control-field col-sm-6">
				...
				<div class="tab-pane" id="tab-data">
						...
						<div class="control-field col-sm-4">
							<div class="input-group">
								...
								<span class="input-group-btn">
									<button class="btn btn-default" id="blog-cat-slug-btn" type="button"><?= $text_build; ?></button>
								</span>
							</div>
							<?php if ($error_slug): ?>
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="image"><b class="required">*</b> <?= $entry_image; ?></label>
						<div class="control-field col-sm-4">
							<div class="media">

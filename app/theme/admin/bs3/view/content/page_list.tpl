			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?= $sort_title; ?>"><?= $column_title; echo ($sort == 'id.title') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right hidden-xs"><a href="<?= $sort_sort_order; ?>"><?= $column_sort_order; echo ($sort == 'i.sort_order') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
				...
				<tbody data-link="row" class="rowlink">
					...
					<tr>
						<td class="rowlink-skip text-center"><?php if ($page['selected']) { ?>
							<input type="checkbox" name="selected[]" value="<?= $page['page_id']; ?>" checked="">
							<?php } else { ?>
							<input type="checkbox" name="selected[]" value="<?= $page['page_id']; ?>">
							<?php } ?></td>
						<td><?= $page['title']; ?></td>
						<td class="text-right hidden-xs"><?= $page['sort_order']; ?></td>
						<td class="text-right"><?php foreach ($page['action'] as $action) { ?>

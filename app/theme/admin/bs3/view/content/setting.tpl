			...
			<div class="tab-content">
				<div class="tab-pane" id="tab-general">
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_name"><b class="required">*</b> <?= $lang_entry_name; ?></label>
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_title"><b class="required">*</b> <?= $lang_entry_title; ?></label>
						<div class="control-field col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_meta_description"><?= $lang_entry_meta_description; ?></label>
						<div class="control-field col-sm-4">
							<textarea name="blog_meta_description" class="form-control" rows="6"><?= $blog_meta_description; ?></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_email"><b class="required">*</b> <?= $lang_entry_email; ?></label>
						<div class="control-field col-sm-4">
				...
				<div class="tab-pane" id="tab-option">
					<h4><?= $lang_text_items; ?></h4>
					<hr>
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_limit"><b class="required">*</b> <?= $lang_entry_blog_limit; ?></label>
						<div class="control-field col-sm-4">
					...
					<h4><?= $lang_text_post; ?></h4>
					<hr>
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_posted_by"><b class="required">*</b> <?= $lang_entry_posted_by; ?></label>
						<div class="control-field col-sm-4">
							...
							<?php if ($blog_posted_by == 'firstname lastname'): ?>
								<option value="firstname lastname" selected="selected"><?= $lang_text_pb_firstname_lastname; ?></option>
								<option value="lastname firstname"><?= $lang_text_pb_lastname_firstname; ?></option>
								<option value="username"><?= $lang_text_pb_username; ?></option>
							<?php elseif ($blog_posted_by == 'lastname firstname'): ?>
								<option value="firstname lastname"><?= $lang_text_pb_firstname_lastname; ?></option>
								<option value="lastname firstname" selected="selected"><?= $lang_text_pb_lastname_firstname; ?></option>
								<option value="username"><?= $lang_text_pb_username; ?></option>
							<?php elseif($blog_posted_by == 'username'): ?>
								<option value="firstname lastname"><?= $lang_text_pb_firstname_lastname; ?></option>
								<option value="lastname firstname"><?= $lang_text_pb_lastname_firstname; ?></option>
								<option value="username" selected="selected"><?= $lang_text_pb_username; ?></option>
							<?php else: ?>
								<option value="firstname lastname"><?= $lang_text_pb_firstname_lastname; ?></option>
								<option value="lastname firstname"><?= $lang_text_pb_lastname_firstname; ?></option>
								<option value="username"><?= $lang_text_pb_username; ?></option>
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_comment_status"><?= $lang_entry_comment; ?></label>
						<div class="control-field col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_comment_logged"><?= $lang_entry_comment_anonymous; ?></label>
						<div class="control-field col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_comment_require_approve"><?= $lang_entry_comment_require_approve; ?></label>
						<div class="control-field col-sm-4">
					...
					<h4><?= $lang_text_account; ?></h4>
					<hr>
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_admin_group_id"><b class="required">*</b> <?= $lang_entry_admin_group; ?></label>
						<div class="control-field col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="blog_author_group_id"><b class="required">*</b> <?= $lang_entry_author_group; ?></label>
						<div class="control-field col-sm-4">
				...
				<div class="tab-pane" id="tab-image">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><b class="required">*</b> <?= $lang_entry_image_post; ?></label>
						<div class="control-field col-sm-4">

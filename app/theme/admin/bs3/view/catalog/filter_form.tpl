...
<div class="panel panel-default">
	<div class="panel-heading">
		<div class="clearfix">
			<div class="pull-left h2"><i class="hidden-xs fa fa-filter"></i><?= $heading_title; ?></div>
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="form-group">
				<label class="control-label col-sm-2"><b class="required">*</b> <?= $entry_group; ?></label>
			...
			<table id="filter" class="table table-bordered table-striped">
				<thead>
					<tr>
					<th class="col-sm-4"><b class="required">*</b> <?= $entry_name ?></th>
				...
				<?php foreach ($filters as $filter) { ?>
					<tr id="filter-row<?= $filter_row; ?>">
						...
						<td><a onclick="$('#filter-row<?= $filter_row; ?>').remove();" class="btn btn-danger"><i class="fa fa-trash-o fa-lg"></i><span class="hidden-xs"> <?= $button_remove; ?></span></a></td>
					</tr>
				<?php $filter_row++; ?>
				<?php } ?>
				</tbody>
				<tfoot>
					<tr>
						<td colspan="2"></td>
						<td><a onclick="addFilter();" class="btn btn-info"><i class="fa fa-plus-circle"></i><span class="hidden-xs"> <?= $button_add_filter; ?></span></a></td>
					</tr>
				</tfoot>
			</table>
		</form>

...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<ul class="nav nav-tabs"><li><a href="#tab-general" data-toggle="tab"><?= $tab_general; ?></a></li><li><a href="#tab-data" data-toggle="tab"><?= $tab_data; ?></a></li><li><a href="#tab-design" data-toggle="tab"><?= $tab_design; ?></a></li></ul>
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="tab-content">
				...
				<div class="tab-pane" id="tab-data">
					<div class="form-group">
						<label class="control-label col-sm-2"><?= $entry_parent; ?></label>
						<div class="control-field col-sm-4">
							<div class="input-group">
								<input type="text" name="path" value="<?= $path; ?>" autocomplete="off" class="form-control">
								<span class="input-group-btn"><a class="btn btn-default" onclick="$('input[name=\'path\']').val('<?= $text_none; ?>');$('input[name=\'parent_id\']').val(0);" title="<?= $text_none; ?>"><i class="fa fa-ban"></i></a></span>
							</div>
							...
							<div class="panel panel-default panel-scrollable">
								<div class="list-group list-group-hover">
									<label class="list-group-item">
										...
										<input type="checkbox" name="category_store[]" value="0" checked=""><?= $text_default; ?>
										<?php } else { ?>
										<input type="checkbox" name="category_store[]" value="0"><?= $text_default; ?>
										<?php } ?>
									</label>
						...
						<div class="control-field col-sm-4">
							<div class="input-group">
								...
								<span class="input-group-btn">
									<button class="btn btn-default" id="cat-slug-btn" type="button"><?= $text_build; ?></button>
								</span>
							</div>
							<?php if ($error_slug): ?>
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?= $entry_top; ?></label>
						<div class="control-field col-sm-4">
							<?php if ($top) { ?>
					...
					<div class="form-group">
						<label class="control-label col-sm-2"><?= $entry_column; ?></label>
						<div class="control-field col-sm-4">

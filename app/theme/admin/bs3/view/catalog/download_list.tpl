			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?= $sort_name; ?>"><?= $column_name; echo ($sort == 'dd.name') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right hidden-xs"><a href="<?= $sort_remaining; ?>"><?= $column_remaining; echo ($sort == 'd.remaining') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
				...
				<tbody data-link="row" class="rowlink">
					...
					<tr>
						<td class="rowlink-skip text-center"><?php if ($download['selected']) { ?>
							<input type="checkbox" name="selected[]" value="<?= $download['download_id']; ?>" checked="">
							<?php } else { ?>
							<input type="checkbox" name="selected[]" value="<?= $download['download_id']; ?>">
							<?php } ?></td>
						<td><?= $download['name']; ?></td>
						<td class="text-right hidden-xs"><?= $download['remaining']; ?></td>

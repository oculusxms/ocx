			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?= $sort_name; ?>"><?= $column_name; echo ($sort == 'ad.name') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th><a href="<?= $sort_attribute_group; ?>"><?= $column_attribute_group; echo ($sort == 'attribute_group') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right hidden-xs"><a href="<?= $sort_sort_order; ?>"><?= $column_sort_order; echo ($sort == 'a.sort_order') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>

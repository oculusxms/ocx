			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?= $sort_name; ?>"><?= $column_name; echo ($sort == 'od.name') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right hidden-xs"><a href="<?= $sort_sort_order; ?>"><?= $column_sort_order; echo ($sort == 'o.sort_order') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
				...
				<tbody data-link="row" class="rowlink">
					...
					<tr>
						<td class="rowlink-skip text-center"><?php if ($option['selected']) { ?>
							<input type="checkbox" name="selected[]" value="<?= $option['option_id']; ?>" checked="">
							<?php } else { ?>
							<input type="checkbox" name="selected[]" value="<?= $option['option_id']; ?>">
							<?php } ?></td>
						<td><?= $option['name']; ?></td>
						<td class="text-right hidden-xs"><?= $option['sort_order']; ?></td>

...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-group">
				<div class="control-field col-sm-8 col-sm-offset-2">
					<div class="alert alert-info">
						<p class="form-control-static"><?= $text_recurring; ?></p>
					</div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_price; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="price" value="<?= $price ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_duration; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="duration" value="<?= $duration ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_cycle; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="cycle" value="<?= $cycle ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_frequency; ?></label>
				<div class="control-field col-sm-4">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_trial_status; ?></label>
				<div class="control-field col-sm-4">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_trial_price; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="trial_price" value="<?= $trial_price ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_trial_duration; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="trial_duration" value="<?= $trial_duration; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_trial_cycle; ?></label>
				<div class="control-field col-sm-4">
					<input type="text" name="trial_cycle" value="<?= $trial_cycle; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_trial_frequency; ?></label>
				<div class="control-field col-sm-4">

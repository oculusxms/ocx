	...
	<div class="panel-body">
		...
		<div class="tab-content">
			<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
						...
						<div class="panel panel-default panel-scrollable">
							<div class="list-group">
								<label class="list-group-item">
									...
									<input type="checkbox" name="manufacturer_store[]" value="0" checked=""><?= $text_default; ?>
									<?php } else { ?>
									<input type="checkbox" name="manufacturer_store[]" value="0"><?= $text_default; ?>
									<?php } ?>
								</label>
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="slug"><?= $entry_slug; ?></label>
					<div class="control-field col-sm-4">
						<div class="input-group">
							<input type="text" name="slug" value="<?= $slug; ?>" class="form-control" id="slug" class="form-control">
							<span class="input-group-btn">
								<button class="btn btn-default" id="man-slug-btn" type="button"><?= $text_build; ?></button>
							</span>
						</div>
						<?php if ($error_slug): ?>

			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?= $sort_name; ?>"><?= $column_name; echo ($sort == 'agd.name') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right hidden-xs"><a href="<?= $sort_sort_order; ?>"><?= $column_sort_order; echo ($sort == 'ag.sort_order') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
				...
				<tbody data-link="row" class="rowlink">
					...
					<tr>
						<td class="rowlink-skip text-center"><?php if ($attribute_group['selected']) { ?>
							<input type="checkbox" name="selected[]" value="<?= $attribute_group['attribute_group_id']; ?>" checked="">
							<?php } else { ?>
							<input type="checkbox" name="selected[]" value="<?= $attribute_group['attribute_group_id']; ?>">
						<?php } ?></td>
						<td><?= $attribute_group['name']; ?></td>
						<td class="text-right hidden-xs"><?= $attribute_group['sort_order']; ?></td>

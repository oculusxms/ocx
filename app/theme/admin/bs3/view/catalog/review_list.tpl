...
<div class="panel panel-default">
	<div class="panel-heading">
		<div class="clearfix">
			<div class="pull-left h2"><i class="hidden-xs fa fa-comments"></i><?= $heading_title; ?></div>
			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?= $sort_product; ?>"><?= $column_product; echo ($sort == 'pd.name') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th><a href="<?= $sort_author; ?>"><?= $column_author; echo ($sort == 'r.author') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right"><a href="<?= $sort_rating; ?>"><?= $column_rating; echo ($sort == 'r.rating') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="hidden-xs"><a href="<?= $sort_status; ?>"><?= $column_status; echo ($sort == 'r.status') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>

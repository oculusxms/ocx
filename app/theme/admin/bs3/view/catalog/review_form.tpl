...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $entry_rating; ?></label>
				<div class="control-field col-sm-4">
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<div class="btn-group" data-toggle="buttons">
						<?php if ($status){ ?>
						<label class="btn btn-default active" title="<?= $text_enabled; ?>"><input type="radio" name="status" value="1" checked=""><i class="fa fa-play"></i></label>
						<label class="btn btn-default" title="<?= $text_disabled; ?>"><input type="radio" name="status" value="0"><i class="fa fa-pause"></i></label>
						<?php } else { ?>
						<label class="btn btn-default" title="<?= $text_enabled; ?>"><input type="radio" name="status" value="1"><i class="fa fa-play"></i></label>
						<label class="btn btn-default active" title="<?= $text_disabled; ?>"><input type="radio" name="status" value="0" checked=""><i class="fa fa-pause"></i></label>
						<?php } ?>
					</div>
				</div>
			</div>

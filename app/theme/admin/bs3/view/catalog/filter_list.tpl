		...
		<form action="<?= $delete; ?>" method="post" enctype="multipart/form-data" id="form">
			<table class="table table-bordered table-striped table-hover">
				<thead>
					...
					<th><a href="<?= $sort_name; ?>"><?= $column_group; echo ($sort == 'fgd.name') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
					<th class="text-right"><a href="<?= $sort_sort_order; ?>"><?= $column_sort_order; echo ($sort == 'fg.sort_order') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>

...
class Propf extends Controller {
    ...
    public function send() {
        ...
        $request.= '&BUTTONSOURCE=' . urlencode('OCX_Cart_PFP');
        ...
        if ($response_info['RESULT'] == '0') {
            ...
            $this->model_checkout_order->update($this->session->data['order_id'], $this->config->get('propf_order_status_id'), $message, false);

...
class Prouk extends Controller {
    public function index() {
        ...
        $this->theme->loadjs('javascript/payment/prouk', $data);
        
        $data = $this->theme->listen(__CLASS__, __FUNCTION__, $data);
        
        $data['javascript'] = $this->theme->controller('common/javascript');
        
        return $this->theme->view('payment/prouk', $data);
    }
    
    public function send() {
        if (!$this->config->get('prouk_transaction')) {
        ...
        $request.= '&USER=' . urlencode($this->config->get('prouk_username'));
        $request.= '&PWD=' . urlencode($this->config->get('prouk_password'));
        $request.= '&SIGNATURE=' . urlencode($this->config->get('prouk_signature'));
        ...
        $request.= '&BUTTONSOURCE=' . urlencode('OCX_Cart_WPP');

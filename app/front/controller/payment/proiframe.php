				...
				if ((strcmp($response, 'VERIFIED') == 0 || strcmp($response, 'UNVERIFIED') == 0) && isset($this->request->post['payment_status'])) {
					...
					if (!$order_info['order_status_id']) {
						$paypal_order_data = array(
							'order_id' => $order_id,
							'capture_status' => ($this->config->get('proiframe_transaction_method') == 'sale' ? 'Complete' : 'NotComplete'),
						...
						$paypal_transaction_data = array(
							...
							'transaction_entity' => ($this->config->get('proiframe_transaction_method') == 'sale' ? 'payment' : 'auth'),

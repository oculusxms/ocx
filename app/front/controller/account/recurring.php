...
class Recurring extends Controller {
    public function index() {
        ...
        $data['pagination'] = $this->theme->paginate($recurring_total, $page, 10, $this->language->get('text_pagination'), $this->url->link('account/recurring', 'page={page}', 'SSL'));
    ...
    public function info() {
        ...
        $data['transaction_types'] = array(0 => $this->language->get('text_transaction_date_added'), 1 => $this->language->get('text_transaction_payment'), 2 => $this->language->get('text_transaction_outstanding_payment'), 3 => $this->language->get('text_transaction_skipped'), 4 => $this->language->get('text_transaction_failed'), 5 => $this->language->get('text_transaction_cancelled'), 6 => $this->language->get('text_transaction_suspended'), 7 => $this->language->get('text_transaction_suspended_failed'), 8 => $this->language->get('text_transaction_outstanding_failed'), 9 => $this->language->get('text_transaction_expired'),);

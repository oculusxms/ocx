...
// Heading
$_['lang_heading_title']    = 'Purchase a Gift Certificate';

// Text
$_['lang_text_account']     = 'Dashboard';
$_['lang_text_voucher']     = 'Gift Voucher';
$_['lang_text_description'] = 'This gift certificate will be E-Mailed to the recipient after payment is completed.';
$_['lang_text_agree']       = 'I understand that gift certificates are non-refundable.';
$_['lang_text_message']     = '<p>Thank you for purchasing a gift certificate. Once you have completed your order, your gift recipient will be sent an E-Mail with details for voucher redemption.</p>';
...
$_['lang_error_agree']      = 'Warning: You must agree that gift certificates are non-refundable.';

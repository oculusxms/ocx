...
$_['text_address_block'] = '<a href="https://twitter.com/twitterpage"><img src="' . parent::$app['http.server'] . 'image/data/email/footer_twitter.gif" width="42" height="42" alt="Twitter" title="Twitter" border="0" /></a><a href="http://www.facebook.com/yourpage"><img src="' . parent::$app['http.server'] . 'image/data/email/footer_fb.gif" width="42" height="42" alt="Facebook" title="Facebook" border="0" /></a><br><span style="color: #848484; font-weight: bold; font-size:14px">' . parent::$app['config_name'] . '</span><br><span style="color: #848484; font-weight: normal;">' . nl2br(parent::$app['config_address']) . '<br>' . parent::$app['config_telephone'] . '</span><br>';

	...
	*/
	...
	$_['text_new_powered'] = 'Powered By <a href="http://ocx.io">OCX</a>.';
	$_['text_new_reward'] = '%s reward points for order number: %s';
	...
	$_['text_hangout_link'] = '<a href="%s">Hangout Link</a>';
	
	$_['text_hangout_alert'] = '<b style="color:red;">** IMPORTANT **</b> Your order contains as least one Event that has a Google Hangout link.  Make sure you keep this receipt so that you can attend your Hangout at the appropriate time.';
	
	$_['text_address'] = 'Address:';
	$_['text_affiliate'] = 'Affiliate:';
	$_['text_customer_group'] = 'Customer group:';
	$_['text_id'] = 'ID';
	$_['text_new_subject_admin'] = 'Order %s - %s (%s)';

...
class Upgrade extends Controller {
    ...
    public function index() {
        ...
        $this->theme->setTitle('OCX Upgrade || Step 1 - Upgrade');
    ...
    public function success() {
        $this->theme->setTitle('OCX Upgrade || Step 2 - Finished');
    ...
    private function validate() {
        ...
        if (!is_readable($this->get('path.application') . 'ocx.sql')):
            $this->error['warning'] = 'Your SQL file, ocx.sql cannot be found.  Please upload a new version of ocx.sql to your <br>app/install directory and then click Continue.';
        endif;

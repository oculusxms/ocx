...
class Menu extends Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) && 
			...
			$data['customer_fields'] = $this->url->link('people/customfield', 'token=' . $this->session->data['token'], 'SSL');
			...
			$data['custom_field'] = $this->url->link('design/customfield', 'token=' . $this->session->data['token'], 'SSL');
			...
			$order_status_total = $this->model_sale_order->getTotalOrders(array(
											'filter_order_status_id' => $this->config->get('config_order_status_id')
			));
			
			$data['order_status_total'] = $order_status_total;
			
			$data['alert_order_status'] = $this->url->link('sale/order', 
										'token=' . $this->session->data['token'] . '&filter_order_status_id='.  $this->config->get('config_order_status_id'), 
										'SSL');
			...
			$data['complete_status_total'] = $this->model_sale_order->getTotalOrders(array(
												'filter_order_status_id' => $this->config->get('config_complete_status_id')
			));
			
			$data['alert_complete_status'] = $this->url->link('sale/order', 
										'token=' . $this->session->data['token'] . '&filter_order_status_id='.  $this->config->get('config_complete_status_id'), 
										'SSL');
			...
			$return_total = $this->model_sale_returns->getTotalReturns(array(
			...
			$data['alert_product'] = $this->url->link('catalog/product', 
								'token=' . $this->session->data['token'] . '&filter_order_status_id='.  $this->config->get('config_complete_status_id'), 
								'SSL');

...
class Saleshipping extends Controller {
    public function index() {
        ...
        $this->breadcrumb->add('heading_title', 'report/saleshipping', $url);
        ...
        $data['pagination'] = $this->theme->paginate($order_total, $page, $this->config->get('config_admin_limit'), $this->language->get('text_pagination'), $this->url->link('report/saleshipping', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL'));

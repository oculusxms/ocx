	...
	public function index() {
		...
		foreach ($results as $result) {
			...
			if ($result['customer_id']) {
				$action[] = array(
					'text' => 'Edit',
					'href' => $this->url->link('people/customer/update', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['customer_id'], 'SSL')
				);
			}
		...
		$data['pagination'] = $this->theme->paginate(
			...
			$this->url->link('report/customeronline', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL')
		);

	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('localization/returnstatus/update', 'token=' . $this->session->data['token'] . '&return_status_id=' . $result['return_status_id'] . $url, 'SSL')
			);
		...
		$data['pagination'] = $this->theme->paginate(
			...
			$this->url->link('localization/returnstatus', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL')
		);

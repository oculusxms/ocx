	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('localization/stockstatus/update', 'token=' . $this->session->data['token'] . '&stock_status_id=' . $result['stock_status_id'] . $url, 'SSL')
			);
		...
		$data['pagination'] = $this->theme->paginate(
			...
			$this->url->link('localization/stockstatus', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL')
		);

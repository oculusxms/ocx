...
class Returnaction extends Controller {
    ...
    protected function getList() {
        ...
        foreach ($results as $result) {
            ...
            $action[] = array('text' => $this->language->get('text_edit'), 'href' => $this->url->link('localization/returnaction/update', 'token=' . $this->session->data['token'] . '&return_action_id=' . $result['return_action_id'] . $url, 'SSL'));
        ...
        $data['pagination'] = $this->theme->paginate($return_action_total, $page, $this->config->get('config_admin_limit'), $this->language->get('text_pagination'), $this->url->link('localization/returnaction', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL'));

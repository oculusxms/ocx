			...
			foreach ($files as $file) {
				...
				if (!in_array($module, $modules)) {
					$action[] = array(
						...
						'href' => $this->url->link('module/total/install', 'token=' . $this->session->data['token'] . '&module=' . $module, 'SSL')
					);
				} else {
					$action[] = array(
						'text' => $this->language->get('text_edit'),
						'href' => $this->url->link('total/' . $module . '', 'token=' . $this->session->data['token'], 'SSL')
					);

					$action[] = array(
						'text' => $this->language->get('text_uninstall'),
						'href' => $this->url->link('module/total/uninstall', 'token=' . $this->session->data['token'] . '&module=' . $module, 'SSL')
					);
				}

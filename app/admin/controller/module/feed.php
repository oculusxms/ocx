			...
			foreach ($files as $file) {
				...
				if (!in_array($module, $modules)) {
					$action[] = array(
						...
						'href' => $this->url->link('module/feed/install', 'token=' . $this->session->data['token'] . '&module=' . $module, 'SSL')
					);
				} else {
					$action[] = array(
						'text' => $this->language->get('text_edit'),
						'href' => $this->url->link('feed/' . $module . '', 'token=' . $this->session->data['token'], 'SSL')
					);

					$action[] = array(
						'text' => $this->language->get('text_uninstall'),
						'href' => $this->url->link('module/feed/uninstall', 'token=' . $this->session->data['token'] . '&module=' . $module, 'SSL')
					);
				}

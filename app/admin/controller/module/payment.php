        ...
        if ($files) {
            foreach ($files as $file) {
                ...
                if (!in_array($module, $modules)) {
                    $action[] = array('text' => $this->language->get('text_install'), 'href' => $this->url->link('module/payment/install', 'token=' . $this->session->data['token'] . '&module=' . $module, 'SSL'));
                } else {
                    $action[] = array('text' => $this->language->get('text_edit'), 'href' => $this->url->link('payment/' . $module . '', 'token=' . $this->session->data['token'], 'SSL'));
                    
                    $action[] = array('text' => $this->language->get('text_uninstall'), 'href' => $this->url->link('module/payment/uninstall', 'token=' . $this->session->data['token'] . '&module=' . $module, 'SSL'));
                }

...
class Menu extends Controller {
	...
	public function getForm() {
		...
		$menu_types = array(
			'product_category' 	=> $this->language->get('text_product_category'),
			'content_category' 	=> $this->language->get('text_content_category'),
			'page' 				=> $this->language->get('text_page'),
			'post' 				=> $this->language->get('text_post'),

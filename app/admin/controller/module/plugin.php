			...
			foreach ($files as $file) {
				...
				if (!in_array($module, $modules)) {
					$action[] = array(
						...
						'href' => $this->url->link('module/plugin/install', 'token=' . $this->session->data['token'] . '&module=' . $module, 'SSL')
					);
				} else {
					if (is_readable($this->app['path.plugin'] . $module . '/admin/controller/' . $module . '.php')):
						$action[] = array(
							'text' => $this->language->get('text_edit'),
							'href' => $this->url->link('plugin/' . $module . '', 'token=' . $this->session->data['token'], 'SSL')
						);
					...
					$action[] = array(
						...
						'href' => $this->url->link('module/plugin/uninstall', 'token=' . $this->session->data['token'] . '&module=' . $module, 'SSL')
					);
				}

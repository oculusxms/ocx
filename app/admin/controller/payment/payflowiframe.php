			...
			if ($paypal_order && $order_info) {
				...
				if ($result['RESULT'] == 0) {
					...
					$actions[] = array(
						...
						'href' => $this->url->link('payment/payflowiframe/refund', 'transaction_reference=' . $result['PNREF'] . '&token=' . $this->session->data['token']),
					);
				...
				switch ($transaction['transaction_type']) {
					...
					case 'S':
						...
						$actions[] = array(
							...
							'href' => $this->url->link('payment/payflowiframe/refund', 'transaction_reference=' . $transaction['transaction_reference'] . '&token=' . $this->session->data['token']),
						);

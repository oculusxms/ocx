...
class Customer extends Controller { 
	...
	public function history() {
		...
		$data['pagination'] = $this->theme->paginate(
			...
			10,
			$this->language->get('text_pagination'),
			$this->url->link('people/customer/history', 'token=' . $this->session->data['token'] . 
					'&customer_id=' . $this->request->get['customer_id'] . '&page={page}', 'SSL')
		);
	...
	public function transaction() {
		...
		$data['pagination'] = $this->theme->paginate(
			...
			10,
			$this->language->get('text_pagination'),
			$this->url->link('people/customer/transaction', 'token=' . $this->session->data['token'] . 
				'&customer_id=' . $this->request->get['customer_id'] . '&page={page}', 'SSL')
		);
	...
	public function reward() {
		...
		$data['pagination'] = $this->theme->paginate(
			...
			10,
			$this->language->get('text_pagination'),
			$this->url->link('people/customer/reward', 'token=' . $this->session->data['token'] . 
				'&customer_id=' . $this->request->get['customer_id'] . '&page={page}', 'SSL')
		);

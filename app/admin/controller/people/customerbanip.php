	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('people/customerbanip/update', 'token=' . $this->session->data['token'] . '&customer_ban_ip_id=' . $result['customer_ban_ip_id'] . $url, 'SSL')
			);
			...
			$data['customer_ban_ips'][] = array(
				...
				'ip'                 => $result['ip'],
				'total'              => $result['total'],
				'customer'           => $this->url->link('people/customer', 'token=' . $this->session->data['token'] . '&filter_ip=' . $result['ip'], 'SSL'),
		...
		$data['pagination'] = $this->theme->paginate(
			$customer_ban_ip_total,
			$page,
			$this->config->get('config_admin_limit'),
			$this->language->get('text_pagination'),
			$this->url->link('people/customerbanip', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL')
		);

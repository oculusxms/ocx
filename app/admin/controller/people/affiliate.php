...
class Affiliate extends Controller { 
	...
	protected function getList() {
		...
		$data['pagination'] = $this->theme->paginate(
			...
			$this->url->link('people/affiliate', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL')
		);
	...
	public function transaction() {
		...
		$data['pagination'] = $this->theme->paginate(
			...
			$this->config->get('config_admin_limit'),
			$this->language->get('text_pagination'),
			$this->url->link('people/affiliate/transaction', 'token=' . $this->session->data['token'] . 
				'&affiliate_id=' . $this->request->get['affiliate_id'] . '&page={page}', 'SSL')
		);

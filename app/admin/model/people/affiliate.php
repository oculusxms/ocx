...
class Affiliate extends Model {
    public function addAffiliate($data) {
        ...
        $this->theme->trigger('admin_add_affiliate', array('affiliate_id' => $affiliate_id));
    }
    ...
    public function approve($affiliate_id) {
        ...
        if ($affiliate_info) {
            ...
            $this->theme->trigger('admin_approve_affiliate', array('affiliate_id' => $affiliate_id));
        }
    }
    ...
    public function addTransaction($affiliate_id, $description = '', $amount = '', $order_id = 0) {
        ...
        if ($affiliate_info) {
            ...
            $this->theme->trigger('admin_add_affiliate_transaction', array('affiliate_transaction_id' => $affiliate_transaction_id));
        }
    }
    ...
    public function getTransactionByOrderId($order_id) {
        $query = $this->db->query("
			SELECT affiliate_transaction_id 
			FROM {$this->db->prefix}affiliate_transaction 
			WHERE order_id = '" . (int)$order_id . "'
		");
        
        return $query->row['affiliate_transaction_id'];
    }
}

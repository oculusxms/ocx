...
class Order extends Model {
	public function addOrder($data) {
		...
		if (!empty($this->request->post['affiliate_id'])) {
			...
			$affiliate_info = $this->model_people_affiliate->getAffiliate($this->request->post['affiliate_id']);
	...
	public function deleteOrder($order_id) {
		...
		$this->db->query("DELETE FROM {$this->db->prefix}order_fraud WHERE order_id = '" . (int)$order_id . "'");
		$this->db->query("DELETE FROM {$this->db->prefix}customer_transaction WHERE order_id = '" . (int)$order_id . "'");

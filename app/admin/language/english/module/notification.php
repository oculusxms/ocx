...
$_['lang_entry_email_slug']         = 'Function Slug:<br><span class="help">This is the function slug that\'s used to call your notification throughout the OCX system. Only user added notification slugs are editable.</span>';

...
$_['entry_filename']   = 'Filename:<br /><span class="help">You can upload via the upload button or use FTP to upload to the download directory and enter the details below.<br /><br />It is recommended that the filename and the mask are different to prevent people from trying to directly link to your downloads.</span>';
$_['entry_mask']       = 'Mask:';

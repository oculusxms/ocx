...
$_['error_slug'] 			 = 'Warning: Slug is required for product categories.';
$_['error_slug_found'] 		 = 'ERROR: The slug %s is already in use, please use a different one in the input field.';
$_['error_name_first']		 = 'ERROR: Please enter a name for your category before attempting to build a slug.';
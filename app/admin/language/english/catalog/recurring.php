...
$_['text_month']			= 'Month';
$_['text_year']				= 'Year';
$_['text_recurring']	    = 'Recurring amounts are calculated by the frequency and cycles.<br>For example if you use a frequency of "week" and a cycle of "2", then the user will be billed every 2 weeks.<br>The duration is the number of times the user will make a payment, set this to 0 if you want payments until they are cancelled.';

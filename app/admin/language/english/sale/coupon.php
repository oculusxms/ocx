...
$_['entry_product']       = 'Products:<br /><span class="help">Choose the specific products the coupon will apply to. Select no products for coupon to apply to entire cart.</span>';
$_['entry_date_start']    = 'Date Start:';
$_['entry_date_end']      = 'Date End:';
$_['entry_uses_total']    = 'Uses Per Coupon:<br /><span class="help">The maximum number of times the coupon may be used by any one customer. Leave blank for unlimited</span>';
$_['entry_uses_customer'] = 'Uses Per Customer:<br /><span class="help">The maximum number of times the coupon may be used by an individual customer. Leave blank for unlimited</span>';

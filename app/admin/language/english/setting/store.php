...
$_['entry_stock_checkout']         = 'Stock Checkout:<br /><span class="help">Allow customers to checkout even if the products they are ordering are not in stock.</span>';
...
$_['entry_secure']                 = 'Use SSL:<br /><span class="help">To use SSL, check with your host to discover if an SSL certificate is installed.</span>';

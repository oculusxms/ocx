...
class Iconv extends LibraryService {
    ...
    public function utf8Strrpos($string, $needle) {
    ...
    public function utf8Strtolower($string) {
        ...
        $unicode = $this->utf8ToUnicode($string);
        
        if (!$unicode):
            return false;
        endif;
        
        $count_unicode = count($unicode);
        ...
        return $this->unicodeToUtf8($unicode);
    }
    ...
    protected function utf8ToUnicode($string) {
        $unicode = array();
    ...
    protected function unicodeToUtf8($unicode) {
        $string = '';

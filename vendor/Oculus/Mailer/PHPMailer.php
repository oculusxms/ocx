...
|
|--------------------------------------------------------------------------
|   Oculus Mailer PHPMailer
|--------------------------------------------------------------------------
|
|   This file is a version of PHPMailer, forked
|   to be included as part of the Oculus Framework Engine.
|   See original Copyright below.
| 
*/

namespace Oculus\Mailer;
use Oculus\Mailer\SMTP;
use Exception;
...
class PHPMailer {
    ...
    public function AddStringAttachment($string, $filename, $encoding = 'base64', $type = 'application/octet-stream') {
        ...
        $this->attachment[] = array(0 => $string, 1 => $filename, 2 => basename($filename), 3 => $encoding, 4 => $type, 5 => true,
         // isStringAttachment
        6 => 'attachment', 7 => 0);
    }

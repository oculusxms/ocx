...
define('FRAMEWORK',   dirname(__DIR__) . '/vendor/Oculus/');
...
$config['base'] = $base; // DO NOT CHANGE THE NAME OF THIS KEY
...
|	Oculus\Engine\Application to search for the correct key in the array.
|
*/
